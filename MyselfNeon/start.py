...
async def send_start(client: Client, message: Message):
    ...
    buttons = [[
        InlineKeyboardButton("👨‍💻 Dᴇᴠᴇʟᴏᴘᴇʀ", url = "https://t.me/kingvj01")
    ],[
        InlineKeyboardButton('♻️ Sᴜᴘᴘᴏʀᴛ', url='https://t.me/vj_bot_disscussion'),
        InlineKeyboardButton('📢 Uᴘᴅᴀᴛᴇs', url='https://t.me/vj_botz')
    ]]
    reply_markup = InlineKeyboardMarkup(buttons)
    await client.send_message(
        chat_id=message.chat.id, 
        text=f"<b>Hello {message.from_user.mention} 🖐️ I am Save Restricted Content Bot, I can send you restricted content by its post link.\n\nFor downloading restricted content /login first.\n\nKnow how to use bot by - /help</b>", 
